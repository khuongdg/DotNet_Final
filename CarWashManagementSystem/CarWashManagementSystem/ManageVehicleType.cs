    ...
    public partial class ManageVehicleType : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cm = new SqlCommand("INSERT INTO VehicleType ( name , class ) VALUES ( @name , @class )", dbcon.connect());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cm = new SqlCommand("UPDATE VehicleType SET name = @name , class = @class WHERE id = @id", dbcon.connect());
