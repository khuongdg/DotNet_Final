        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (check)
                {
                    ...
                    {
                        cm = new SqlCommand("INSERT INTO CostofGood ( costname , cost , date ) VALUES ( @costname , @cost , @date )", dbcon.connect());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (check)
                {
                    ...
                    {
                        cm = new SqlCommand("UPDATE CostofGood SET costname = @costname, cost = @cost, date = @date WHERE id=@id", dbcon.connect());
