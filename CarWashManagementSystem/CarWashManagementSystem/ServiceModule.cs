    ...
    public partial class ServiceModule : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cm = new SqlCommand("INSERT INTO Service ( name , price ) VALUES ( @name , @price )", dbcon.connect());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cm = new SqlCommand("UPDATE Service SET name=@name, price=@price WHERE id=@id", dbcon.connect());
