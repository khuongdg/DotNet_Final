...
namespace CarWashManagementSystem
{
    public partial class CustomerModule : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (check)
                {
                    ...
                    {
                        cm = new SqlCommand("INSERT INTO Customer (vid, name, phone, carno, carmodel, address, points) VALUES (@vid , @name , @phone , @carno , @carmodel , @address , @points)", dbcon.connect());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (check)
                {
                    ...
                    {
                        cm = new SqlCommand("UPDATE Customer SET vid=@vid, name=@name, phone=@phone, carno=@carno, carmodel=@carmodel, address=@address, points=@points WHERE id=@id", dbcon.connect());
        ...
        {
            cm = new SqlCommand("SELECT * FROM VehicleType", dbcon.connect());
